...
export default function CastLoginPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      localStorage.setItem("cast_id", String(data.cast_id));
      localStorage.setItem("cast_account_id", String(data.id));
      localStorage.setItem("cast_name", data.cast_name);
      localStorage.setItem("cast_shop_id", String(data.shop_id));
      router.push("/cast-portal");
    } catch {
