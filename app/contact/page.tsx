    ...
    return (
      <>
        ...
        <main style={{ maxWidth: 680, margin: "0 auto", padding: "60px 16px", textAlign: "center" }}>
          ...
          <h1 style={{ color: "#fff", fontSize: 22, fontWeight: 800, marginBottom: 12 }}>お問い合わせを受け付けました</h1>
    ...
    <>
      ...
      <main style={{ maxWidth: 680, margin: "0 auto", padding: "24px 16px 60px" }}>
        <div style={{ marginBottom: 32 }}>
          <div style={{ fontSize: 11, color: "#ff6b9d", letterSpacing: "0.15em", marginBottom: 6 }}>CONTACT</div>
          <h1 style={{ fontSize: 24, fontWeight: 900, color: "#fff", letterSpacing: "-0.03em" }}>お問い合わせ</h1>
          <p style={{ color: "#ffffff55", fontSize: 13, marginTop: 8, lineHeight: 1.8 }}>
        ...
        <div style={{
          ...
          fontSize: 12, color: "#ffffff55", lineHeight: 1.8,
        }}>
          当サイトの掲載情報は公開情報をもとに作成しています。情報の修正・削除をご希望の店舗様はお気軽にご連絡ください。迅速に対応いたします。
        </div>

        <div style={fieldStyle}>
          <label style={labelStyle}>お問い合わせ種別 <span style={{ color: "#ff6b9d" }}>*</span></label>
        ...
        <div style={fieldStyle}>
          <label style={labelStyle}>お名前 <span style={{ color: "#ff6b9d" }}>*</span></label>
        ...
        <div style={fieldStyle}>
          <label style={labelStyle}>お問い合わせ内容 <span style={{ color: "#ff6b9d" }}>*</span></label>
          <textarea
            value={form.message}
