...
export default function ShopCard({ shop }: { shop: Shop }) {
  const tc = TYPE_COLORS[shop.type] ?? {
    bg: '#fff1',
    border: '#fff3',
    text: '#fff',
  };
      ...
      >
            ...
            {shop.image ? (
              ...
              <div
                style={{
                  width: '100%',
                  height: '100%',
                  background: `linear-gradient(135deg, ${tc.border}22, #0f0f1a)`,
                  display: 'flex',
                  alignItems: 'center',
        ...
        {isStandard && (
          <div
            style={{
              width: '100%',
              height: 60,
              background: 'linear-gradient(135deg, #00d4ff08, #0f0f1a)',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
          ...
          >
            ...
            <span style={{ fontSize: 11, color: '#00d4ff66' }}>
              プレミアムで写真掲載できます
            </span>
          </div>
        )}
        ...
        <div style={{ padding: 20 }}>
          ...
          >
            <div
              style={{
                ...
                overflow: 'hidden',
                border: `1.5px solid ${
                  hasBanner && shop.image ? tc.border + '66' : '#ffffff15'
                }`,
          ...
          >
            ...
            <span
              style={{ fontSize: 12, color: onCount > 0 ? '#00ff88' : '#666' }}
            >
              <span
                style={{
                  ...
                  height: 7,
                  borderRadius: '50%',
                  background: onCount > 0 ? '#00ff88' : '#444',
                  boxShadow: onCount > 0 ? '0 0 6px #00ff88' : 'none',
                  marginRight: 5,
