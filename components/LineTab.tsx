        ...
        {connected ? (
          ...
          <div>
            <button
              ...
              style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, width: "100%", padding: "16px 24px", borderRadius: 14, background: "#06c755", color: "#fff", fontWeight: 800, fontSize: 16, border: "none", cursor: "pointer" }}
            >
            ...
            <p style={{ fontSize: 11, color: "var(--text-hint)", marginTop: 8, textAlign: "center" }}>
              LINEのログイン画面に移動します。許可するとLINEに通知が届くようになります。
            </p>
          </div>
        )}
